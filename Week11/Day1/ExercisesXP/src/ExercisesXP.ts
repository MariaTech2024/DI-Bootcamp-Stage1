...
//const myName: string = "John Smith";
...
const sum = add(5, 10); // Should return 15
const concatenated = add("Hello, ", "world!"); // Should return "Hello, world!"
...
// Example usage:
const [myName, age, greeting] = getDetails("John", 30);
...
function greet(): string; // Function signature for no arguments
function greet(name: string): string; // Function signature for name argument
